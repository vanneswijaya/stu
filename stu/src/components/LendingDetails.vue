...
<template>
  <div class="h-full bg-dark pb-10">
    <div class="px-4 pt-4">
      <img class="rounded-t-lg brightness-50" src="https://s3.amazonaws.com/www.starterstory.com/story_images/images/000/001/636/original/open-uri20190519-4-1l5lbl7?1558272181" alt="">
    </div>
    <div class="px-4">
        ...
        <div class="flex">
          ...
          <div class="text-white text-sm flex items-center">
            <div class="leading-tight">
              ...
              <span class="text-gray-500 text-xs">joined 10 months ago</span>
            </div>
          </div>
        </div>
      ...
      <div class="text-xs text-white font-thin text-justify mb-4">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
      </div>
      <div class="text-xs text-white font-thin text-justify">
